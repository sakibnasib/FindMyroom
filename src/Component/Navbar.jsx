  ...
  return (
    <div className="navbar bg-base-100 px-5 shadow-sm">
      <div className="navbar-start">
        ...
        <a className="flex justify-center items-center font-extrabold ml-3 text-xl p-0">
          <span>
            <img className="rounded-full w-[50px] h-[50px]" src={icon} alt="" />
          </span>{" "}
          FindMyRoom
        </a>
      </div>
      ...
      <div className="navbar-end space-y-1">
        ...
        <label className="swap ml-1 swap-rotate">
